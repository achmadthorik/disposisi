          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> Update Surat<small><?php echo $id_surat_masuk?></small></h2>
          ...
          ?>
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="tanggal_entri" class="form-control col-md-7 col-xs-12" type="text" name="tanggal_entri" required value="<?php echo $tanggal_entri ?>" readonly>
                        </div>
                      </div>

                         <div class="form-group">
                        <label for="id_user" class="control-label col-md-3 col-sm-3 col-xs-12">USER<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="id_user" class="form-control col-md-7 col-xs-12" type="text" name="id_user" required value="<?php echo"$id_user"?>" readonly>
                        </div>
                      </div>
