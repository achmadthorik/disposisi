          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> TAMBAH SURAT BARU <small></small></h2>
         ...
         //   include "koneksi.php";
          ...
          ?>
                      ...
                      <textarea id="deskripsi" name="deskripsi" class="resizable_textarea form-control" placeholder="Isikan Maksut dan tujuan surat ini datang"></textarea>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="tanggal_entri" class="form-control col-md-7 col-xs-12" type="date" name="tanggal_entri" required value="<?php echo date('Y-m-d')?>" readonly>
                        </div>
                      </div>
