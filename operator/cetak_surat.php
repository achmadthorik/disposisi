  ...
  <table class="bordered" id="tbl">
               <tbody>
                            ...
                            <tr>
                                ...
                                <td id="left" style="border-right: none;" width="57%">: <?php echo $id_surat_keluar"/.../"$tanggal_surat ?></td>
                            ...
                            <tr>
                                ...
                                <td id="left" colspan="2">: pakbos</td>
                            </tr>
                            
                            <tr>
                                <td id="right"><strong>Hal</strong></td>
                                <td id="left" colspan="2">:Pemesananm</td>
                                
                            </tr>
                            <tr>
                                <td id="right"><strong>Tanggal Penyelesaian</strong></td>
                                <td id="left" colspan="2">: tgl surat</td>
                            </tr>
                            <tr>
                            <tr class="isi">
                                <td colspan="3">
