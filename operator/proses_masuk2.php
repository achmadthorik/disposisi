...
if (isset($_POST['submit']))
{
	...
	$q = "INSERT INTO `surat_masuk` (`id_surat_masuk`,`id_jenis`, `pengirim`, `alamat_pengirim`, `nomor_surat`,`perihal`,`deskripsi`,`tanggal_surat`,`nama_file`,`tanggal_entri`) VALUES ('$id_surat_masuk','$id_jenis','$pengirim','$alamat_pengirim','$nomor_surat','$perihal','$tanggal_surat','$nama_file','$tanggal_entri')";
